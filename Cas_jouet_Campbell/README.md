Les notebooks font appel à différentes fonctions que l'on retrouve dans les fichiers python *model_class*, *ACPF*, *Gaussian_processes* , *methods_for_scalar_input* et *validation_gp* qui sont dans le repertoire **Methodes**.
